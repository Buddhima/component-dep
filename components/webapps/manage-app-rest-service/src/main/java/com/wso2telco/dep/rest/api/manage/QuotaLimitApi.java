...
import com.wso2telco.dep.rest.api.manage.quotalimit.entity.QuotaBean;
import com.wso2telco.dep.rest.api.manage.quotalimit.entity.QuotaReqBean;
import com.wso2telco.dep.rest.api.manage.quotalimit.entity.QuotaReqBeanWithDates;
import com.wso2telco.dep.rest.api.manage.quotalimit.service.QuotaLimitService;

@Path("/services")
public class QuotaLimitApi {

	private static final Logger LOG = Logger.getLogger(QuotaLimitApi.class.getName());
